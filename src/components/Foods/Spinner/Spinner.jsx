...
const Spinner = ({ setStorageData }) => {
  ...
  return (
    <div id="spinner" className="w-[100%] h-auto pt-[200px] px-[40px] sm:px-[10px]">
      <h1 className="text-[40px] mb-[40px] font-bold">SPINNER</h1>
      <div className="w-[90%] grid grid-cols-6 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-[20px] m-auto sm:justify-around sm:items-center">
        {cards.length === 0
          ...
          :
          cards.filter(data => data.type === "spinner").map((data) => (
            <div
